...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('OPEN m_Facebook_CanvasApp_MDDslTst_Player_Brain')
}




var aM_Facebook_CanvasApp_MDDslTst_Player_Brain = function (
    ...
    if( typeof fChoirJS_LogModuleLoads === 'function') {
        fChoirJS_LogModuleLoads('BEGIN m_Facebook_CanvasApp_MDDslTst_Player_Brain')
    }


    var _displayName = 'm_Facebook_CanvasApp_MDDslTst_Player_Brain';
    ...
    if( typeof MDDslTstBrainId === 'string') {
        someMotionCollections.push( MDDslTstBrainId);
        document.getElementById( 'MDD-ElementId_Field').value = MDDslTstBrainId;
        document.getElementById( 'MDD-ElementId_Group').style.display = 'inline';
    }
    else {
        document.getElementById( 'MDD-ElementId_Field').value = 'UNKNOWN MDDslTstBrainId';
        document.getElementById( 'MDD-ElementId_Group').style.display = 'inline';
        return null;
    }
...
if (typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('REGISTER m_Facebook_CanvasApp_MDDslTst_Player_Brain')
}
...
if (typeof define === 'function') {
    ...
    define(['m_ConstValues', 'm_ConstValues_Tools','m_Ctxt', 'm_Trace', 'm_Defense',
        ...
        function (m_ConstValues, m_ConstValues_Tools, m_Ctxt, m_Trace, m_Defense,
            ...
            return aM_Facebook_CanvasApp_MDDslTst_Player_Brain(
                m_ConstValues, m_ConstValues_Tools, m_Ctxt, m_Trace, m_Defense,
                m_MotionPics, m_Facebook_CanvasApp_MDDslTst_Player);
        });
}
    ...
    if (typeof gChoirJS_Modules === 'object') {
        gChoirJS_Modules[aM_Facebook_CanvasApp_MDDslTst_Player_Brain.displayName] = aM_Facebook_CanvasApp_MDDslTst_Player_Brain(
        ...
        ChoirJS_Module_Facebook_CanvasApp_MDDslTst_Player_Brain = aM_Facebook_CanvasApp_MDDslTst_Player_Brain(
...
if (typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('DEFINED m_Facebook_CanvasApp_MDDslTst_Player_Brain')
}
