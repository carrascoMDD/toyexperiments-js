...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('OPEN m_Facebook_CanvasApp_MDDslTst_Player_Neuron')
}




var aM_Facebook_CanvasApp_MDDslTst_Player_Neuron = function (
    ...
    if( typeof fChoirJS_LogModuleLoads === 'function') {
        fChoirJS_LogModuleLoads('BEGIN m_Facebook_CanvasApp_MDDslTst_Player_Neuron')
    }


    var _displayName = 'm_Facebook_CanvasApp_MDDslTst_Player_Neuron';
...
if (typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('REGISTER m_Facebook_CanvasApp_MDDslTst_Player_Neuron')
}
...
if (typeof define === 'function') {
    ...
    define(['m_ConstValues', 'm_ConstValues_Tools','m_Ctxt', 'm_Trace', 'm_Defense',
        ...
        function (m_ConstValues, m_ConstValues_Tools, m_Ctxt, m_Trace, m_Defense,
            ...
            return aM_Facebook_CanvasApp_MDDslTst_Player_Neuron(
                m_ConstValues, m_ConstValues_Tools, m_Ctxt, m_Trace, m_Defense,
                m_MotionPics, m_Facebook_CanvasApp_MDDslTst_Player);
        });
}
    ...
    if (typeof gChoirJS_Modules === 'object') {
        gChoirJS_Modules[aM_Facebook_CanvasApp_MDDslTst_Player_Neuron.displayName] = aM_Facebook_CanvasApp_MDDslTst_Player_Neuron(
        ...
        ChoirJS_Module_Facebook_CanvasApp_MDDslTst_Player_Neuron = aM_Facebook_CanvasApp_MDDslTst_Player_Neuron(
...
if (typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('DEFINED m_Facebook_CanvasApp_MDDslTst_Player_Neuron')
}
