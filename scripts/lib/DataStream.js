/*
 * DataStream.js
 * from https://github.com/kig/DataStream.js
 * wrapper for requirejs Copyright 2013 Antonio Carrasco Valero
 *
 * Wrapper for node.js availabel at https://gist.github.com/PyYoshi/5141607
 *
 */

if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('OPEN m_DataStream')
}



var aM_DataStream = function (m_Functionx, m_Error, m_Instrument, m_Trace, m_Encoding) {


    if( typeof fChoirJS_LogModuleLoads === 'function') {
        fChoirJS_LogModuleLoads('BEGIN m_DataStream')
    }
    ...
    var _displayName = 'm_DataStream';

    var _doc = _displayName +' module. To access structured information in Typed Arrays.';
    ...
    DataStream.prototype.writeString = function(s, encoding, length) {
      if (encoding == null || encoding == "ASCII") {
        ...
        this.writeUint8Array((new m_Encoding.TextEncoder(encoding)).encode(s.substring(0, length)));
      }
    };
    ...
    if( typeof fChoirJS_LogModuleLoads === 'function') {
        fChoirJS_LogModuleLoads('END m_DataStream')
    }
...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('REGISTER m_DataStream')
}
...
if( typeof define === 'function') {
    ...
    define(['m_Functionx', 'm_Error', 'm_Instrument', 'm_Trace', 'm_Encoding'], function (m_Functionx, m_Error, m_Instrument, m_Trace, m_Encoding) {

        return aM_DataStream(m_Functionx, m_Error, m_Instrument, m_Trace, m_Encoding);
    });
}
else {

    if( typeof gChoirJS_Modules === 'object') {
        gChoirJS_Modules[aM_DataStream.displayName]=aM_DataStream(
            gChoirJS_Modules['m_Functionx'],
            gChoirJS_Modules['m_Error'],
            gChoirJS_Modules['m_Instrument'],
            gChoirJS_Modules['m_Trace'],
            gChoirJS_Modules['m_Encoding']
        );
    }
    else {
        ChoirJS_Module_DataStream= aM_DataStream(
            ChoirJS_Module_Functionx,
            ChoirJS_Module_Error,
            ChoirJS_Module_Instrument,
            ChoirJS_Module_Trace,
            ChoirJS_Module_Encoding
        );
    }
}
...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('DEFINED m_DataStream')
}
