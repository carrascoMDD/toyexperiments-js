/*
* Encoding.js
* from https://github.com/kig/Encoding.js
...
/* Removed by ACV for requirejs wrapper
(function(global) {
  'use strict';
...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('OPEN m_Encoding')
}



var aM_Encoding = function (m_Functionx, m_Error, m_Instrument, m_Trace) {

    if( typeof fChoirJS_LogModuleLoads === 'function') {
        fChoirJS_LogModuleLoads('BEGIN m_Encoding')
    }
    ...
    var _displayName = 'm_Encoding';

    var _doc = _displayName +' module. To convert string representations between encodings.';
 ...
 /* ACV OJO TODO : after running ok many times, I started to get on 201305291150 an error global is not defined */
 global = {};
...
*/
    ...
    if( typeof fChoirJS_LogModuleLoads === 'function') {
        fChoirJS_LogModuleLoads('END m_Encoding')
    }
...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('REGISTER m_Encoding')
}
...
if( typeof define === 'function') {
    ...
    define(['m_Functionx', 'm_Error', 'm_Instrument', 'm_Trace'], function (m_Functionx, m_Error, m_Instrument, m_Trace) {
        ...
        return aM_Encoding(m_Functionx, m_Error, m_Instrument, m_Trace);
    });
}
else {

    if( typeof gChoirJS_Modules === 'object') {
        gChoirJS_Modules[aM_Encoding.displayName]=aM_Encoding(
        ...
        ChoirJS_Module_Encoding= aM_Encoding(
...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('DEFINED m_Encoding')
}
