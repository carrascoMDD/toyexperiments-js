...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('OPEN m_Experiment_PerformanceVisualizer01')
}
...
require(['m_ConstValues', 'm_ConstValues_Tools', 'm_Choir_Score_Sample_01', 'm_ChangeVisualizer',
    ...
    if( typeof fChoirJS_LogModuleLoads === 'function') {
        fChoirJS_LogModuleLoads('BEGIN m_Experiment_PerformanceVisualizer01')
    }
   ...
   setTimeout(
    ...
    if( typeof fChoirJS_LogModuleLoads === 'function') {
        fChoirJS_LogModuleLoads('END m_Experiment_PerformanceVisualizer01')
    }
...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('DEFINED m_Experiment_PerformanceVisualizer01')
}
