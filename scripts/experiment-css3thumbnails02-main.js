...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('OPEN m_Experiment_CSS3Thumbnails02')
}


require(['m_ConstValues', 'm_ConstValues_Tools', 'm_Clock', 'm_Ctxt', 'm_Geometry', 'm_CSSrules', 'm_MotionPics' ],
    function(m_ConstValues, m_ConstValues_Tools, m_Clock, m_Ctxt, m_Geometry, m_CSSrules, m_MotionPics) {


        if( typeof fChoirJS_LogModuleLoads === 'function') {
            fChoirJS_LogModuleLoads('BEGIN m_Experiment_CSS3Thumbnails02')
        }
        ...
        })._sName( 'm_Experiment_CSS3Thumbnails02', 'pBackgroundClicked')._sTrace( false)._DefendWith([
                [ 'theCtxt'],
                [ 'theEvent',       ['object']]
            ]);
        ...
        })._sName( 'm_Experiment_CSS3Thumbnails02', 'fMotionPicsClicked')._sTrace( false)._DefendWith([
                [ 'theCtxt'],
        ...
        })._sName( 'm_Experiment_CSS3Thumbnails02', 'pToCenterStage')._sTrace( false)._DefendWith([
            [ 'theCtxt'],
            [ 'theMotionPics', ['Type', 'MotionPics']]
        ]);
        ...
        })._sName( 'm_Experiment_CSS3Thumbnails02', '_fCanvasPositionLeft')._sTrace( false)._DefendWith([
            [ 'theCtxt'],
            [ 'theMotionPics', ['Type', 'MotionPics']]
        ]);
        ...
        })._sName( 'm_Experiment_CSS3Thumbnails02', 'pBackToThumbnail')._sTrace( false)._DefendWith([
                [ 'theCtxt'],
                [ 'theMotionPics', ['Type', 'MotionPics']]
            ]);
        ...
        })._sName( 'm_Experiment_CSS3Thumbnails02', 'pAddClass')._sTrace( false)._DefendWith([
                [ 'theCtxt'],
                [ 'theElement',       ['object']],
                [ 'theClassName',       ['string']]
            ]);
        ...
        })._sName( 'm_Experiment_CSS3Thumbnails02', 'fHasClass')._sTrace( false)._DefendWith([
                [ 'theCtxt'],
                [ 'theElement',       ['object']],
                [ 'theClassName',       ['string']]
            ]);
        ...
        if( typeof fChoirJS_LogModuleLoads === 'function') {
            fChoirJS_LogModuleLoads('END m_Experiment_CSS3Thumbnails02')
        }
...
if( typeof fChoirJS_LogModuleLoads === 'function') {
    fChoirJS_LogModuleLoads('DEFINED m_Experiment_CSS3Thumbnails02')
}
